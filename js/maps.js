...
var locations=[
    ...
    [locationData('images/resource/map-card.jpg', 'job-single-v1.html', "Audi, Q5", 'Segment', 'London, UK', ), 40.641311, -73.778139, 5, '<div style="background-image: url(images/resource/map-card.jpg);"></div>'], 
    [locationData('images/resource/map-card.jpg', 'job-single-v1.html', "Audi, Q5", 'Segment', 'London, UK', ), 41.080938, -73.535957, 6, '<div style="background-image: url(images/resource/map-card.jpg);"></div>'], 
    [locationData('images/resource/map-card.jpg', 'job-single-v1.html', "Audi, Q5", 'Segment', 'London, UK', ), 41.079386, -73.519478, 7, '<div style="background-image: url(images/resource/map-card.jpg);"></div>'], 
];
